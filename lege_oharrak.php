...
<head>
    <meta charset="UTF-8">
    <title>Lege Oharrak eta Cookieen Politika</title>
...
<main>
    ...
    <form>
        ...
        <p>
            Webgune honen jabea dagokion enpresa da, eta hemen argitaratutako
            eduki guztien erabilera legearen arabera arautzen da.
        </p>

        <p>
            Erabiltzaileak konpromisoa hartzen du webgunea modu egokian erabiltzeko
            eta indarrean dagoen legedia errespetatzeko.
        </p>

        <p>
            Enpresak ez du bere gain hartzen webgunearen erabilera desegokiak
            eragin ditzakeen kalteen erantzukizuna.
        </p>
    </form>

    <form>
        <h2>Cookieen Politika</h2>

        <p>
            Webgune honek cookieak erabiltzen ditu erabiltzailearen nabigazioa
            errazteko eta esperientzia hobetzeko.
        </p>

        <p>
            Cookieak informazio txikiak dira, erabiltzailearen gailuan gordetzen
            direnak webgunea bisitatzen denean.
        </p>

        <p>
            Erabiltzaileak cookieak onartu, konfiguratu edo desgaitu ditzake
            bere nabigatzailearen ezarpenen bidez.
        </p>

        <p>
            Webgunean nabigatzen jarraitzeak cookieen erabilera onartzea dakar.
        </p>
    </form>
