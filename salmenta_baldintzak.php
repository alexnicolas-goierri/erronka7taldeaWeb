...
<head>
    <meta charset="UTF-8">
    <title>Salmenta Baldintzak</title>
...
<main>
    ...
    <form>
        <h2>Salmenta Baldintzak</h2>

        <p>
            Webgune honen bidez egindako erosketek ondorengo salmenta baldintzak
            onartzea dakarte.
        </p>

        <p>
            Produktu guztien prezioak eurotan adierazita daude eta BEZa barne dute,
            kontrakoa adierazi ezean.
        </p>

        <p>
            Ordainketak modu seguruetan egingo dira, eta eskaera baieztatu ondoren
            hasiko da bidalketa-prozesua.
        </p>

        <p>
            Enpresak eskubidea du prezioak, produktuak edo baldintzak aldatzeko,
            aurrez jakinarazi gabe.
        </p>

        <p>
            Erabiltzaileak konpromisoa hartzen du emandako datuak egiazkoak eta
            eguneratuak izateko.
        </p>
    </form>
