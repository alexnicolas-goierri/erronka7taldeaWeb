...
<main>
    ...
    <form>
        ...
        <p>
            Webgune honetan erabiltzaileen izenak eta identifikazio-datuak
            erabilera egoki eta arduratsuarekin tratatzen dira.
        </p>

        <p>
            Erabiltzailearen izena soilik honako helburuetarako erabiliko da:
        </p>

        <ul>
            <li>Erabiltzailea identifikatzea</li>
            <li>Kontuaren kudeaketa</li>
            <li>Komunikazio pertsonalizatua</li>
        </ul>

        <p>
            Inolaz ere ez da erabiltzailearen izena hirugarrenei lagako,
            legeak hala eskatzen ez badu.
        </p>

        <p>
            Erabiltzaileak edozein unetan bere izena aldatu edo ezabatzeko
            eskubidea du.
        </p>
    </form>
